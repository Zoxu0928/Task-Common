...
func (decoder *generalStructDecoder) decodeOneField(ptr unsafe.Pointer, iter *Iterator) {
	...
	// 优化：如果有错误，记录下错误字段
	if iter.Error != nil && iter.ErrorFix == nil {
		iter.ErrorFix = &UnmarshalTypeError{Field: strings.Title(field)}
	}
}
...
func (decoder *structFieldDecoder) Decode(ptr unsafe.Pointer, iter *Iterator) {
	...
	// 优化：如果有错误，记录下错误字段
	if iter.Error != nil && iter.ErrorFix == nil {
		iter.ErrorFix = &UnmarshalTypeError{Field: strings.Title(decoder.field.Name())}
	}
}
